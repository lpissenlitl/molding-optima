...
import { usersMethod, getOptions } from '@/api'
  ...
  data() {
    return {
      ...
      columns_setting: [
        ...
        { visible: true, label: "企业", prop: "company_name", width: 120, align: "center", header_align: "center", sortable: false, tooltip: false}, 
        { visible: true, label: "组织", prop: "group_name", width: 120, align: "center", header_align: "center", sortable: false, tooltip: true}, 
