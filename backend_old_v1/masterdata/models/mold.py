...
class GatingSystem(AbstractBaseModel):
    ...
    hot_runner_system_type = models.CharField(null=True, max_length=20, verbose_name="热流道类型")
    ...
    valve_actuation_type = models.CharField(null=True, max_length=50, verbose_name="针阀驱动方式")
...
class Cavity(AbstractBaseModel):
    ...
    # --- 制品名称 ---
    product_name = models.CharField(null=True, max_length=50, verbose_name="制品名称")
    product_code = models.CharField(null=True, max_length=50, verbose_name="制品编号")
...
class Gate(AbstractBaseModel):
    ...
    gate_type = models.CharField(null=True, max_length=20, verbose_name="浇口类型")
...
class EjectionSystem(AbstractBaseModel):
    ...
    ejection_type = models.CharField(null=True, max_length=20, verbose_name="顶出类型")
    reset_method = models.CharField(null=True, max_length=20, verbose_name="复位方式")
