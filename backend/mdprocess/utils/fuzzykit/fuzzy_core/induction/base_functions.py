...
def recalibrate_proba(
    ...
    require_min_samples : bool, default=True
        ...
        Setting to False will warn, but still replace RuleMethod probabilities even if the minimum number of samples is not met.
    """
    ...
    # Assign collected frequencies to RuleMethod
