...
class AuxiliaryEquipmentDetailView(BaseView):
    ...
    def get(self, request, auxiliary_equipment_id):
        """获取辅助装置详情"""
        return auxiliary_service.get_auxiliary_equipment_info(
            auxiliary_equipment_id=auxiliary_equipment_id
        )
    ...
    def put(self, request, auxiliary_equipment_id, cleaned_data):
        """更新辅助装置信息"""
        return auxiliary_service.update_auxiliary_equipment(
            auxiliary_equipment_id=auxiliary_equipment_id,
            **cleaned_data
        )
    ...
    def delete(self, request, auxiliary_equipment_id):
        """删除辅助装置"""
        return auxiliary_service.delete_auxiliary_equipment(
            auxiliary_equipment_id=auxiliary_equipment_id
        )
...
class AuxiliaryEquipmentListView(BaseView, PaginationResponse):
    ...
    def post(self, request, cleaned_data):
        """创建辅助装置"""
        return auxiliary_service.create_auxiliary_equipment(
    ...
    def get(self, request, cleaned_data):
        """获取辅助装置列表"""
        total, items = auxiliary_service.get_auxiliary_equipment_list(
            company_id=request.user.company_id,
            **cleaned_data
        )
    ...
    def delete(self, request, cleaned_data):
        """批量删除辅助装置"""
        return auxiliary_service.batch_delete_auxiliary_equipment(**cleaned_data)
