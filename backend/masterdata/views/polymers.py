...
class PolymerDetailView(BaseView):
    ...
    def get(self, request, polymer_id):
        """获取单个聚合物信息"""
        return polymer_service.get_polymer_info(
    ...
    def put(self, request, polymer_id, cleaned_data):
        """更新单个聚合物信息"""
        return polymer_service.update_polymer_info(
            polymer_id=polymer_id,
            **cleaned_data
        )
    ...
    def delete(self, request, polymer_id):
        """删除单个聚合物"""
        return polymer_service.delete_polymer(
            polymer_id=polymer_id
        )
...
class PolymerListView(BaseView, PaginationResponse):
    ...
    def post(self, request, cleaned_data):
        """创建单个聚合物信息"""
        return polymer_service.create_polymer(
    ...
    def get(self, request, cleaned_data):
        """获取聚合物列表信息"""
        total, results = polymer_service.get_polymer_list(
            company_id=request.user.company_id,
            **cleaned_data
        )
    ...
    def delete(self, request, cleaned_data):
        """批量删除聚合物信息"""
        return polymer_service.batch_delete_polymer(**cleaned_data)
