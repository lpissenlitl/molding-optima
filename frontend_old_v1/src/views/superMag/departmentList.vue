    ...
    <div class="toolbar">
      ...
      >
        <el-form-item label="组织名称">
          <el-input v-model="query.company_name" clearable style="width:10rem" />
        </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      columns_setting: [
        { id: 0, visible: true, label: "组织名称", prop: "company_name", width: 120, align: "center", header_align: "center", sortable: false, tooltip: false}, 
        { id: 1, visible: true, label: "部门名称", prop: "name", width: 120, align: "center", header_align: "center", sortable: false, tooltip: false}, 
        { id: 2, visible: true, label: "状态", prop: "deleted", width: 60, align: "center", header_align: "center", sortable: false, tooltip: false}, 
        { id: 3, visible: true, label: "部门缩写", prop: "abbreviation", width: 100, align: "center", header_align: "center", sortable: false, tooltip: false},
        { id: 4, visible: true, label: "部门编号", prop: "serial_number", width: 100, align: "center", header_align: "center", sortable: false, tooltip: false},
        { id: 5, visible: true, label: "负责人", prop: "header", width: 100, align: "center", header_align: "center", sortable: false, tooltip: false},
        { id: 6, visible: true, label: "部门描述", prop: "description", width: 240, align: "center", header_align: "center", sortable: false, tooltip: false}
      ],
