...
export default {
  ...
  data() {
    return {
      ...
      columns_setting: [
        { id: 0, visible: true, label: "角色名称", prop: "name", width: 120, align: "center", header_align: "center", sortable: false, tooltip: false}, 
        { id: 1, visible: true, label: "状态", prop: "deleted", width: 60, align: "center", header_align: "center", sortable: false, tooltip: false}, 
        { id: 2, visible: true, label: "角色描述", prop: "description", width: 300, align: "left", header_align: "center", sortable: false, tooltip: false},
      ],
